...
| `Docs/Roadmap_SPOD.md` | Этапы 0–9 с отметками **[сделано] / [частично] / [не сделано]**, бэклог |
...
- **[сделано]** Документация: README, ТЗ, системные требования, план работ, roadmap с явными статусами **[сделано]/[частично]/[не сделано]**.
